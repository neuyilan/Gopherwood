...
//        }
//
//        THROW(GopherwoodBadConfigFoumat, "Config cannot parse configure file: \"%s\"",
//              path);
//    }
...
//                THROW(GopherwoodBadConfigFoumat,
...
//            THROW(GopherwoodBadConfigFoumat, "Cannot read configure file: \"%s\", %s",
